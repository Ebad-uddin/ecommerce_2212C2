...
<?php 
    ...
    $fetch_data = "SELECT * from `userdata` where `status` = '0'";
...
<table class="table table-bordered mt-5">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center"> <a class="btn btn-danger text-center" href="delete.php?id=<?php echo $data['id'] ?>"> <i class="fa-solid fa-trash"></i></a>  </td>
        </tr>
        <?php 
            }
            }
